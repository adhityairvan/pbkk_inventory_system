...
<!-- End of Topbar -->
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-4 text-gray-800">Edit Item form</h1>
                
    <div class="row">
        <div class="col-md-12">
            <?= $this->flashSession->output() ?>
            <form method="post" action="<?= $this->url->get('item/update/5') ?>" enctype="multipart/form-data">
